import { Autocomplete, Avatar, Box, Button, Card, Modal } from "@mui/material";
import * as React from "react";
import { DataGrid, GridToolbar } from "@mui/x-data-grid";
import TextField from "@mui/material/TextField/TextField";
import { ButtonStyles, Modelstyle } from "./styles";
  ...
  const columns = [
...

    {
      ...
      renderCell: () => {
        return (
          <div>
            <Button onClick={handleOpen}>Edit User Roles</Button>
            <Modal
              open={open}
              onClose={handleClose}
